    ...
    _createClass(Carousel, [{
        ...
        value: function renderItems() {
            ...
            return _react.Children.map(this.props.children, function (item, index) {
                var itemClass = _cssClasses2.default.ITEM(_this2.props.classNamePrefix, true, index === _this2.state.selectedItem);
                var slideProps = {
                    ref: function ref(e) {
                        return _this2.setItemsRef(e, index);
                    },
                    key: 'itemKey' + index,
                    className: _cssClasses2.default.ITEM(_this2.props.classNamePrefix, true, index === _this2.state.selectedItem),
            ...
            return _react2.default.createElement(
                ...
                _react.Children.map(this.props.children, function (item, index) {
                    return _react2.default.createElement('li', {
                        className: _cssClasses2.default.DOT(_this3.props.classNamePrefix, index === _this3.state.selectedItem),
        ...
        value: function render() {
            ...
            var swiperProps = {
                selectedItem: this.state.selectedItem,
                className: _cssClasses2.default.SLIDER(this.props.classNamePrefix, true, this.state.swiping),
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    {
                        className: _cssClasses2.default.CAROUSEL(this.props.classNamePrefix, true),
                        style: { width: this.props.width }
                    },
                    _react2.default.createElement('button', {
                        type: 'button',
                        className: _cssClasses2.default.ARROW_PREV(this.props.classNamePrefix, !hasPrev),
                        onClick: this.decrement
                    }),
                    _react2.default.createElement(
                        'div',
                        {
                            className: _cssClasses2.default.WRAPPER(this.props.classNamePrefix, true, this.props.axis),
                    ...
                    _react2.default.createElement('button', {
                        type: 'button',
                        className: _cssClasses2.default.ARROW_NEXT(this.props.classNamePrefix, !hasNext),
