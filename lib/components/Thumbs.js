    ...
    _createClass(Thumbs, [{
        ...
        value: function renderItems() {
            ...
            return this.state.images.map(function (img, index) {
                var itemClass = _cssClasses2.default.ITEM(_this2.props.classNamePrefix, false, index === _this2.state.selectedItem && _this2.state.hasMount);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: _cssClasses2.default.CAROUSEL(this.props.classNamePrefix, false) },
                _react2.default.createElement(
                    'div',
                    {
                        className: _cssClasses2.default.WRAPPER(this.props.classNamePrefix, false),
                    ...
                    _react2.default.createElement(
                        _reactEasySwipe2.default,
                        {
                            ...
                            className: _cssClasses2.default.SLIDER(this.props.classNamePrefix, false, this.state.swiping),
